...
+ All the distributions you need are available in NIMBLE^[Parallel w/ distributions in R? Forward ref to other distributions used in next chapters? Mention that you can write your own? Example below? Illustrate with dbeta(1,1) in place of dunif(0,1)].  
