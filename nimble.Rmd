...
+ The most common distributions are available in NIMBLE. For example we will use later in the book `dbeta`, `dmultinom` and `dnorm` among others. If you cannot find what you need in NIMBLE, you can write your own distribution as illustrated in Section \@ref(write-your-own-distribution).
...
We use MCMCvis, but there are other perfectly valid options out there like ggmcmc and basicMCMCplots. **Show these other options?**
