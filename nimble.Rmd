...
**Here I need to tell how to install the nimble package**
...
Note before you install `nimble` like any other R package, Windows users will need to install `Rtools`, and Mac users will need to install `Xcode`. More at <https://r-nimble.org/download>. 
...
At first glance, using several steps instead of doing all these at once with `nimbleMCMC()` seems odds. Why is it useful? First, knowing what is under the hood can help you debug your code which is something I have always find hard to do with other software. Second, mastering the whole sequence of steps allows you to play around with samplers, by changing the samplers that NIMBLE pick by defaults, or even write your own samplers.
...
+ By having full control of the workflow, you can debug your code in NIMBLE, change default MCMC samplers or even write your own samplerr.

## Suggested reading

I this chapter, I have only scratched the surface of what NIMBLE is capable of. Below is a list of pointers that should help you going further with NIMBLE. 
...
- You can learn a lot by going through the training material from NIMBLE workshops at [https://github.com/nimble-training](https://github.com/nimble-training).
