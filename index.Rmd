...
Welcome to the website of the book *Bayesian Analysis of Capture-Recapture Data with Hidden Markov Models – Theory and Case Studies in R* by [Olivier Gimenez](https://oliviergimenez.github.io/). Note that the book is also available in [PDF format](https://github.com/oliviergimenez/banana-book/raw/master/docs/bayesHMMcapturerecapture.pdf).
