...
I'm currently writing this book, and I welcome any feedback `r emo::ji("innocent")` by raising an issue [here](https://github.com/oliviergimenez/banana-book/issues), amending directly the R Markdown file that generated the page you're reading by clicking on the 'Edit this page' icon in the right panel, or simply via [email](mailto:olivier.gimenez@cefe.cnrs.fr). Many thanks!
