...
Welcome to the website of the book *Bayesian Analysis of Capture-Recapture Data with Hidden Markov Models – Theory and Case Studies in R* by [Olivier Gimenez](https://www.linkedin.com/in/keith-mcnulty/).  The book is available in [PDF format](https://github.com/oliviergimenez/banana-book/raw/master/docs/bayesHMMcapturerecapture.pdf) or [online](https://oliviergimenez.github.io/banana-book/).

I'm currently writing this book, and I welcome any feedback or requests for content [here](https://github.com/oliviergimenez/banana-book/issues).
