...
(ref:captionbeta) The distribution beta($\alpha$,$\beta$) for different values of $\alpha$ and $\beta$. Note that for $\alpha = \beta = 1$, we get the uniform distribution between 0 and 1, see top left panel.
