...
**About imagination... I have assembled a searchable list at <https://oliviergimenez.github.io/curated-list-of-HMM-CR-papers/> with HMM analyses of capture-recapture data for you to get inspiration. This list is not exhaustive, please get in touch with me if you'd like to add a reference.**

**About CPU time. Parallel computation and pooled encounter histories. Hope to come up with a function soon in nimbleEcology.**
...
Maybe for the second edition: Batch marking, Continuous, Semi-markov (e.g. for senescence or stopover duration, @choquet_semi-markov_2011), Spatial capture recapture and Integrated pop models. And multievent pour `nimbleEcology`. 
