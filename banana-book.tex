...
caption{Bayes' theorem spelt out in blue neon. Source: \href{https://en.wikipedia.org/wiki/Bayes\%27_theorem}{Wikipedia}\}\label{fig:bayestheorem}
\end{figure}
...
\DocumentationTok{\#\#         Mean Median St.Dev. 95\%CI\_low 95\%CI\_upp}
\DocumentationTok{\#\# theta 0.3409  0.339 0.06097    0.2267     0.469}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{banana-book_files/figure-latex/unnamed-chunk-166-1.pdf}
...
\includegraphics{banana-book_files/figure-latex/unnamed-chunk-168-1.pdf}
...
\includegraphics{banana-book_files/figure-latex/unnamed-chunk-175-1.pdf}
...
\includegraphics{banana-book_files/figure-latex/unnamed-chunk-176-1.pdf}
...
\begin{figure}
\includegraphics[width=0.6\linewidth]{images/Marzo_BaguesMance} \caption{White-throated Dipper (Cinclus cinclus)}\label{fig:unnamed-chunk-181}
\end{figure}

\begin{figure}
\includegraphics[width=0.6\linewidth]{images/Marzocuissardes} \caption{Gilbert Marzolin}\label{fig:unnamed-chunk-182}
\end{figure}
...
\includegraphics{banana-book_files/figure-latex/unnamed-chunk-206-1.pdf}

\includegraphics{banana-book_files/figure-latex/unnamed-chunk-207-1.pdf}
...
\includegraphics[width=11.74in]{images/arnason1973}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{knitr}\SpecialCharTok{::}\FunctionTok{include\_graphics}\NormalTok{(}\StringTok{"images/schwarz1993.png"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics[width=12.72in]{images/schwarz1993}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{knitr}\SpecialCharTok{::}\FunctionTok{include\_graphics}\NormalTok{(}\StringTok{"images/deadpool.gif"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{images/deadpool.gif}

Thank you Canada!

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{knitr}\SpecialCharTok{::}\FunctionTok{include\_graphics}\NormalTok{(}\StringTok{"images/nichols.png"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics[width=39.42in]{images/nichols}

\hypertarget{wintering-site-fidelity-in-canada-geese}{%
\section{Wintering site fidelity in Canada Geese}\label{wintering-site-fidelity-in-canada-geese}}
...
\includegraphics{banana-book_files/figure-latex/unnamed-chunk-214-1.pdf}

Observations and states are closely related, but not entirely.

\includegraphics{banana-book_files/figure-latex/unnamed-chunk-215-1.pdf}
...
\includegraphics{banana-book_files/figure-latex/unnamed-chunk-218-1.pdf}
...
\includegraphics{banana-book_files/figure-latex/unnamed-chunk-221-1.pdf}
...
\includegraphics{banana-book_files/figure-latex/unnamed-chunk-229-1.pdf}
...
\begin{figure}
\centering
\includegraphics{banana-book_files/figure-latex/unnamed-chunk-230-1.pdf}
...
\includegraphics{banana-book_files/figure-latex/unnamed-chunk-234-1.pdf}
...
\includegraphics{banana-book_files/figure-latex/unnamed-chunk-238-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{knitr}\SpecialCharTok{::}\FunctionTok{include\_graphics}\NormalTok{(}\StringTok{"images/sooty.jpg"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics[width=25in]{images/sooty}

\hypertarget{sooty-shearwater-david-boyle}{%
\subsection{Sooty shearwater (David Boyle)}\label{sooty-shearwater-david-boyle}}

\hypertarget{sooty-shearwaters-and-life-history-tradeoffs}{%
\section{Sooty shearwaters and life-history tradeoffs}\label{sooty-shearwaters-and-life-history-tradeoffs}}

We consider data collected between 1940 and 1957 by Lance Richdale on Sooty shearwaters (aka titis).

These data were reanalyzed with multistate models by \href{https://link.springer.com/article/10.1198/108571101750524607}{Scofield et al.~(2001)} who kindly provided us with the data.
...
\hypertarget{sooty-shearwaters-and-life-history-tradeoffs-1}{%
\section{Sooty shearwaters and life-history tradeoffs}\label{sooty-shearwaters-and-life-history-tradeoffs-1}}
...
\begin{figure}
\centering
\includegraphics{banana-book_files/figure-latex/unnamed-chunk-247-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{knitr}\SpecialCharTok{::}\FunctionTok{include\_graphics}\NormalTok{(}\StringTok{"images/multistate\_local\_minimav2\_Page\_05.png"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics[width=22.65in]{images/multistate_local_minimav2_Page_05}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{knitr}\SpecialCharTok{::}\FunctionTok{include\_graphics}\NormalTok{(}\StringTok{"images/multistate\_local\_minimav2\_Page\_06.png"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics[width=32.49in]{images/multistate_local_minimav2_Page_06}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{knitr}\SpecialCharTok{::}\FunctionTok{include\_graphics}\NormalTok{(}\StringTok{"images/multistate\_local\_minimav2\_Page\_07.png"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics[width=32.49in]{images/multistate_local_minimav2_Page_07}

\includegraphics{banana-book_files/figure-latex/unnamed-chunk-252-1.pdf}
...
\tightlist
\item
  Lebreton, J.-D., J. D. Nichols, R. J. Barker, R. Pradel and J. A. Spendelow (2009). \href{https://multievent.sciencesconf.org/conference/multievent/pages/Lebretonetal2009AER.pdf}{Modeling Individual Animal Histories with Multistate Capture--Recapture Models}. Advances in Ecological Research, 41:87-173.
\end{itemize}
